    ...
    service.getDashboards = function(userId){
        return $http.get('/api/preferences/v1/dashboards').then(function successCallback(response) {
            var standardItemsOne = [
                { id: 0, sizeX: 15, sizeY: 8, row: 0, col: 0, displayItem: {ci: 'cpus', id: 0, category: 'usage', title:"CPUS 0 USAGE ", displayAsChart:true, realtime:true}},
                { id: 1, sizeX: 15, sizeY: 8, row: 0, col: 15, displayItem: {ci: 'cpu-cores', id: 0, category: 'usage', title:"CPU-CORES 0 USAGE", displayAsChart:true, realtime:true}},
                { id: 2, sizeX: 15, sizeY: 8, row: 8, col: 10, displayItem: {ci: 'cpu-cores', id: 1, category: 'usage', title:"CPU-CORES 1 USAGE", displayAsChart:true, realtime:true}}

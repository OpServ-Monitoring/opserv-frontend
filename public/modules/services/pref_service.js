    ...
    service.getDashboards = function(userId){
        return $http.get('/api/preferences/v1/dashboards').then(function successCallback(response) {
            var standardItemsOne = [
                // { id: 0, sizeX: 15, sizeY: 8, row: 0, col: 0, displayItem: {ci: 'cpus', id: 0, category: 'usage', title:"CPUS 0 USAGE - Live", displayAsChart:true, realtime:true}},
                { id: 1, sizeX: 15, sizeY: 8, row: 8, col: 0, displayItem: {ci: 'cpu-cores', id: 0, category: 'usage', title:"CPU-CORES 0 USAGE", displayAsChart:true, realtime:true}},
                { id: 1, sizeX: 15, sizeY: 8, row: 8, col: 0, displayItem: {ci: 'cpu-cores', id: 1, category: 'usage', title:"CPU-CORES 1 USAGE", displayAsChart:true, realtime:true}}
            ...
            var standardItemstwo =[
             //   { id:0, sizeX: 10, sizeY: 12, row: 0, col: 0, displayItem: {ci: 'cpus', id: 0, category: 'usage', title:"CPUS 0 USAGE - Live", displayAsChart:true, realtime:true}}
                //{ id:1, sizeX: 2, sizeY: 2, row: 13, col: 2, displayItem: {type: 'text', config:{}} }
            ];

            var dashboards=[
                { title: 'First Monitor',widgets:standardItemsOne, baseUrl: ''}, // https://397b6935.ngrok.io
                { title: 'Second Monitor',widgets:standardItemstwo, baseUrl: ''},
                { title: 'Monitor',widgets:standardItemstwo, baseUrl: ''}
            ];
